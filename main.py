        ...
        for container in product_containers:
            ...
            if nome_tag:
                ...
                if search_words.issubset(product_words):
                    ...
                    # Pegando corretamente a imagem a partir do ancestral maior
                    produto_container = container.find_parent('div', class_='sc-c5cd0085-0 fWmXTW')
                    imagem_tag = produto_container.find('img') if produto_container else None
