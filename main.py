...
import urllib.parse # Importa para analisar URLs, mantido caso seja útil para futuras expansões

# Configuração da página
st.set_page_config(page_title="Busca de Produtos Nagumo Nagumo", page_icon="🛒")
        ...
        for product_block in all_product_blocks:
            ...
            if img_tag and 'alt' in img_tag.attrs:
                ...
                if search_words.issubset(img_alt_words):
                    nome_text = img_alt_text # Usa o texto do alt como o nome principal
                    product_identified = True
                    # Pega a URL da imagem diretamente do atributo 'src'
                    img_url = img_tag.get('src')
            
            # Se o produto foi identificado pela imagem (alt text)
            if product_identified:
                ...
                # Retorna todas as informações encontradas
...
if busca:
    ...
    # Exibe a URL da imagem por escrito, como solicitado
