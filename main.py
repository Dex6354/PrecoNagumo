...
if busca:
    nome, preco, descricao, imagem_url = buscar_produto_nagumo(busca)  # Unpack all four values
    st.write(f"**Produto:** {nome}")
    st.write(f"**Preço:** {preco}")
    st.write(f"**Descrição:** {descricao}")  # Fixed to use 'descricao' instead of 'nome'
