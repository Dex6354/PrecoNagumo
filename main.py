        ...
        for container in product_containers:
            ...
            if nome_tag:
                ...
                if search_words.issubset(product_words):
                    ...
                    # LOGICA SIMPLES PARA IMAGEM:
                    imagem_tag = container.find_previous('div', class_='sc-bczRLJ sc-f719e9b0-0 sc-c5cd0085-2 hJJyHP dbeope eKZaNO')
                    imagem_src = None
                    if imagem_tag:
                        img = imagem_tag.find('img')
